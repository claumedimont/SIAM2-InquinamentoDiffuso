'''
CODE TO MERGE 'ANAGRAFICA' WITH 'IDROCHIMICA' FOR ANY CONTAMINANT
BEFORE THE FINAL VERSION OF THE FILES WAS READY 
...
data_Cr = pd.read_excel(os.path.join(folder_2, "Rete_TCM.xlsx"))

# %%
# Prepare & merge with first coords file
...
# %%
# Prepare & merge with second coords file
...
# Deal with formatting issues & merge
...
# %%
merged_3.to_excel(os.path.join(folder_2,"TCM_ReteCoords.xlsx"))
# %%
